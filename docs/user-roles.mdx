...
Add, edit, search, print, and export student records for their assigned school. Print Avery **5163** or **94205** labels in batches.

## Intake Member

**Scope:** Assigned school

Access only the **Intake Form**. Register new and returning students, capture and verify addresses (NEW), run live duplicate checks (name + address), enforce session hours, flag potential siblings, and log visits. Cannot access the main dashboard or admin tools.
