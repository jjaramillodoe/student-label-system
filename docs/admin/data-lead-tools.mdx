...
<Tip>
  On **Find & print**, use the **Needs label** chip to list only students who have **never** been printed (full print history, not just recent jobs). See [Labels and scanning](/workflows/labels-and-scanning#needs-label).
</Tip>
