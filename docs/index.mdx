...
<AccordionGroup>
  ...
  <Accordion title="Needs label — never printed">
    On Find &amp; print, the **Needs label** chip shows only students who have never appeared in print history. After you print from the app, they drop off that list. See [Labels and scanning](/workflows/labels-and-scanning#needs-label).
  </Accordion>
