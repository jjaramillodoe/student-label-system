...
<Frame caption="School portal sign-in — branded layout with school name for that subdomain">
  <img src="/images/screenshots/sign-in-school-portal.png" alt="Split-panel sign-in on school1.nycadultedlabels.nyc with School 1 portal marker" />
</Frame>
