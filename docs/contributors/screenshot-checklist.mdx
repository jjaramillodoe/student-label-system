...
| Cabinets card with Section 01–08 grid visible | `cabinets-sections.png` | [Cabinets](/storage/cabinets-and-drawers) |
| Dashboard Location with Cab / Draw / Sec | `dashboard-location-section.png` | [Data Lead tools](/admin/data-lead-tools) |
| Avery preview after Last, First + 5-digit sequence ship | refresh `avery-print-preview.png` | [Labels](/workflows/labels-and-scanning) |
