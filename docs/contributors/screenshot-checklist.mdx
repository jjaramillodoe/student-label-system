...
| ThoughtSpot Liveboard (Admin) | `thoughtspot-analytics.png` | [Enrollment](/admin/enrollment-dashboard) |
...
<Warning>
  ...
  Use an **Admin** account for Email Validation and ThoughtSpot shots.
</Warning>
