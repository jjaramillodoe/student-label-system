...
| `cabinets-page.png` (refresh) | [Cabinets](/storage/cabinets-and-drawers) | **Active** / **Archived** tabs, Archive on active cards, Restore on archived |
| `generate-isrf.png` | [Generate ISRF](/workflows/generate-isrf) | Search, selected student, field preview, Download |
...
| Cabinets Archived tab + Restore | `cabinets-archived-tab.png` | [Cabinets](/storage/cabinets-and-drawers#active-and-archived-cabinets) |
| Archive packing preview | `archive-packing-preview.png` | [Archive](/storage/archive-and-school-year) |
| NEW intake demographics (employment / race / barriers) | `intake-demographics.png` | [Intake](/workflows/intake#new-student-demographics) |
