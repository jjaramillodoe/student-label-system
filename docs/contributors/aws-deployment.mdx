...
<CardGroup cols={2}>
  <Card title="AWS support email template" icon="envelope" href="/contributors/aws-support-request">
    Copy-paste email when contacting AWS Solutions Architects.
  </Card>
...
| Item | Value |
| --- | --- |
| Current URL | [student-label-system.vercel.app](https://student-label-system.vercel.app) |
