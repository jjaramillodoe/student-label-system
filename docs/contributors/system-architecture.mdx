...
| ISRF | `/admin/isrf`, `/api/isrf` | Fill FY2027 Individual Student Record Form PDF |
| Students | `/api/students`, `/admin/students/*` | CRUD, bulk upload, lookup |
| Storage | `/admin/cabinets`, `/api/cabinets/*` | Cabinets, drawers, archive flag (`isArchived` / `status`), archive boxes |
