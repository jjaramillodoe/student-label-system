...
<CardGroup cols={2}>
  ...
  <Card title="All Students" icon="users" href="/admin/data-lead-tools">
    **Admin → All Students** (`/admin/students/all`) — edit address, verify batch, export with Apt column.
  </Card>
...
<Steps>
  <Step title="Filter unverified addresses">
    Open **Admin → All Students**. Filter by **Address not yet verified** or **Needs review**.
  </Step>
...
The intake duplicate check and **Admin → Duplicates** both compare home addresses:
