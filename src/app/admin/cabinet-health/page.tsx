    ...
    <div className="w-full p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-bold text-foreground">Cabinet Health</h1>
          <p className="text-muted-foreground mt-1">
            Review active cabinet storage, empty drawers, over-capacity cabinets, and bad assignments.
            Archived cabinets use archive boxes and are managed on the Cabinets page.
          </p>
        </div>
