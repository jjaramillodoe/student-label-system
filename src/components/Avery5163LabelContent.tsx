...
/** Inner content for one Avery 5163 label: name/DOB/seq/barcode left, QR right. */
export default function Avery5163LabelContent({
  student,
  sequence,
}: {
  student: Avery5163LabelStudent;
      ...
      >
        ...
        <div
          style={{
            ...
            lineHeight: 1.3,
            fontWeight: 400,
            marginBottom: seqText ? '0.04in' : LABEL_DOB_TO_BARCODE_GAP,
          }}
        >
          DOB: {student.dob}
        </div>
